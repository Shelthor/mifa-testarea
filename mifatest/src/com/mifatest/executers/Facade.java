...
// - - - Hibernate - - - //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* Konstruktor �ffnet Session und beginnt Transaktion*/
	Session session;
	Transaction t;
...
//Bewertungen/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public List<User> getUsersWhoAreRatedByUserId(int fahrtID, int userID){
		//gib Liste mit Bewerteten Usern zur�ck, zugeh�rig zur Fahrt *fahrtID und zum Sender *userID
...
//Users//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 	...
 	public void newUser(String mail, Date bDate, String nachn, String vorn, String tel, String pw){
	    ...
	    //session.merge(user); 	//diese Zeile hat bei mir Probleme gemacht, scheint als w�rde er
	    						//den user automatisch mit "mergen", weil user=fremdschl�ssel in passwort
 	...
 	{
 	//from mifatest.user where eMail = 'hallo@tsch�ss.de';
